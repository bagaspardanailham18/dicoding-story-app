...
import com.dicoding.intermediate.storyapp.data.local.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val responseData = apiService.getAllStories(token, page, state.config.pageSize, 0).listStory
